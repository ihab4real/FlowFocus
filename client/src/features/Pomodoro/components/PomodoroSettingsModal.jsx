        ...
        <div className="grid gap-4 py-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleNumberChange("focusDuration", e.target.value, 1, 120)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleNumberChange("longBreakDuration", e.target.value, 5, 60)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleNumberChange("longBreakInterval", e.target.value, 2, 10)}
            />
          </div>
