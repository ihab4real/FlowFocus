...
const HabitCard = ({
  ...
  const hasLongDescription =
    habit.description && habit.description.length > 120;
  ...
  return (
    <div className="relative">
      <div
        ...
        ${isCompleted ? "ring-2" : ""}
        ${
          isHovered && hasLongDescription
            ? "absolute top-0 left-0 right-0 z-50 shadow-2xl scale-105 origin-top"
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center space-x-3 flex-1">
            ...
            <div className="flex-1 min-w-0">
              ...
              {habit.description && (
                <p
                  className={`text-sm text-muted-foreground leading-relaxed transition-all duration-300 whitespace-pre-line ${
                    isHovered && hasLongDescription
                      ? ""
